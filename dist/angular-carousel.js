                ...
                compile: function (tElement, tAttributes) {
                    ...
                    return function (scope, iElement, iAttributes) {
                        ...
                        if (angular.isDefined(iAttributes.rnCarouselIndicator)) {
                            scope.templatea = iAttributes.rnCarouselIndicator;
                            scope.indicatorTitle = [];
                            scope.titleClass = iAttributes.rnCarouselIndicatorTitleClass;

                            for (var i = 0; i < iAttributes.$$element[0].children.length; i++) {

                                if (iAttributes.$$element[0].children[i].title) {

                                    scope.indicatorTitle.push(iAttributes.$$element[0].children[i].title)

                                }
                            }


                            var indicator = $compile("<div id='carousel-" + carouselId + "-indicator'  title='indicatorTitle' titleClass=titleClass  index='indicatorIndex' items='carouselIndicatorArray' rn-carousel-indicators class='rn-carousel-indicator'></div>")(scope);
